...
.style4 {font-family: "Comic Sans MS"; font-size: 16px; color: #0000FF; }
-->
</style>
</head>
<body><br><br><br>
...
<table width="93%" border="0" align="center">
	<tr><td width="10%"><span class="style4">Nama</span></td>
		<td width="2%">:</td>
		<td width="88%">
<?php echo"<input name=\"nama\" $disabled type=\"text\" style=\"width: 100%\" value=\"$nama\">"; ?>
	...
	<tr><td valign="top"><span class="style4">Komentar</span></td>
  	...
  	<tr>
     		<td valign="top"><span class="style4">Photoku</span></td>
      		<td valign="top">:</td>
